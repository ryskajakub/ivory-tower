// import { TableToQuery } from "./From";
// import { DisjointUnion, toObj } from "./helpers";
// import { Condition, Join, Q } from "./__sql";
...
//     JOIN = <B>(table: TableType<B>, on: (ab: DisjointUnion<A["columns"], TableToQuery<B>["columns"]>) => Condition): Query<TypedQsql<DisjointUnion<A["columns"], TableToQuery<B>["columns"]>>> => {
